...
export const RU = {
	...
	"settings.deck.filesDesc": "По одному пути к заметке в хранилище на строку.",
	...
	"study.useTableTitle": "Использовать только эту таблицу?",
	"study.useTableDescription": "Текущий выбор таблиц будет заменён.",
	"study.useTable": "Использовать эту таблицу",
	...
	"setup.finishDescription": "Вы можете изменить каждое поле позже в редакторе.",
