...
export const RU = {
	...
	"launcher.summary": "Карты {cards} · Таблицы {tables}",
	...
	"scope.missing": "Отсутствуют сохраненные таблицы: {count}.",
	"table.untitled": "Таблица {number}",
	"table.open": "Открыть эту таблицу",
	"table.preview": "Предварительный просмотр строки",
	"browser.title": "Найти карту",
	"browser.search": "Поиск содержимого карточки",
	"browser.results": "Совпадения: {count}",
	"browser.showing": "Показаны {shown} из {total}",
	"browser.noMatches": "Нет подходящих карт",
	"browser.empty": "Просмотрите карточки или начните вводить текст",
	"browser.row": "Строка {number}",
	"study.search": "Найти карту",
	"study.useTableTitle": "Использовать только эту таблицу?",
	"study.useTableDescription": "Это заменяет текущую область действия нескольких таблиц.",
	"study.useTable": "Используйте эту таблицу",
	"setup.title": "Настройка Table Cards",
	"setup.step": "Шаг {current} из {total}",
	"setup.dataTitle": "Выберите свои данные",
	"setup.dataDescription": "Добавляйте заметки или папки, затем выбирайте таблицы для изучения.",
	"setup.presetTitle": "Выберите макет карты",
	"setup.presetDescription": "В рекомендации используются ваши реальные столбцы и значения.",
	"setup.finishTitle": "Назовите свою колоду",
	"setup.finishDescription": "Вы можете изменить каждое поле позже в редакторе.",
	"setup.next": "Продолжить",
	"setup.recommended": "Рекомендуется",
	"setup.scanSummary": "Карточки {cards} · Таблицы {tables} · Поля {fields}",
	"setup.detectedTypes": "Обнаруженные типы столбцов",
	"setup.noSources": "Выберите хотя бы одну заметку или папку.",
	"setup.noTables": "Таблицы Markdown не найдены.",
	"setup.noCards": "В выбранных таблицах нет карточек для изучения",
	"setup.deckName": "Название колоды",
	"setup.ribbonHint": "Пин-колоды, которые вы часто открываете.",
	...
	"ribbon.show": "Показать эту колоду на левой ленте",
	"ribbon.icon": "Значок ленты",
	"ribbon.moveUp": "Переместить колоду вверх",
	"ribbon.moveDown": "Переместить колоду вниз",
	"ribbon.pinHint": "Прикрепляйте только те колоды, которые вы часто открываете.",
	"editor.source.chooseTables": "Выбрать столы",
	"editor.source.summaryAll": "Все таблицы {count}",
	"editor.source.summarySome": "{selected} из таблиц {total}",
	"editor.source.summaryNone": "Таблицы не выбраны",
	"diagnostic.sourceMissing": "Источник отсутствует: {path}.",
	"diagnostic.tableMissing": "Выбранная таблица отсутствует",
	"diagnostic.requiredEmpty": "Строки пропущены, поскольку обязательные поля пусты: {count}.",
	"diagnostic.brokenImage": "Отсутствуют файлы изображений: {count}.",
