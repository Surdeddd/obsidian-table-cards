export const EN = {
	...
	"modal.empty": "No cards in this deck. Check file paths and column names in the layout editor.",
	"modal.deck": "Deck",
	...
	"editor.row.previous": "Previous row",
	"editor.row.next": "Next row",
	...
	"editor.noColumns": "No columns yet. Add a note or folder with a table.",
	...
	"setup.finishDescription": "You can change every field later in the layout editor.",
	"setup.next": "Continue",
